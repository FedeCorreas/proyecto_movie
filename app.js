...
http.createServer((req, res) => {
	...
	switch (req.url) {
		// Home
		case '/':
            /*1. a. Título : Bienvenidos a DH Movies el mejor sitio para encontrar las mejores
           ...
           const piePagina = '\nRecordá que podés visitar las secciones:\n\n• En Cartelera (/en-cartelera)\n• Más votadas(/mas-votadas)\n• Sucursales (/sucursales)\n• Contacto(/contacto)\n• Preguntas Frecuentes (/preguntas-frecuentes)';
			res.end('Home\n' + titulo + totalPeli + listandoPeli + peliListas + piePagina);            //res.end es como decirle al navegador: enviá esta respuesta con estos datos.
			break;
		// En cartelera
		case '/en-cartelera':
